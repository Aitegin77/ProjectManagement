...
namespace Tests.Unit
{
    ...
    public class ProjectServiceTests : BaseTest
    {
        ...
        public ProjectServiceTests()
        {
            ...
            Service = new ProjectService(repository, documentService);
        }
        ...
        {
            // Arrange
            var filter = new ProjectDto.Filter()
            {
                Name = ProjectTestData.Name
            };

            // Act
            var project = await Service.GetByFilterAsync(filter);
        ...
        public async Task GetByFilterAsync_FilterByDate_ReturnsProjects()
        {
            ...
            var filter = new ProjectDto.Filter()
            {
                StartFrom = ProjectTestData.Date,
